...
public class Resources {
    ...
    public static final MediaObject[] MEDIA_OBJECTS = {
            ...
            new MediaObject("Bad Habits",
                    "https://youtu.be/sR_--MJhmzQ",
                    "https://p.kindpng.com/picc/s/181-1810652_smiling-ed-sheeran-ed-sheeran-high-quality-hd.png",
                    "bad habits by ed sheren"),
    };
}
